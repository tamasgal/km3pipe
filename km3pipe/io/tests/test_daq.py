...
from km3pipe.io.daq import (
    BinaryPump, DAQPreamble, DAQHeader, DAQSummaryslice, DMMonitor, TMCHRepump
)
...
class TestBinaryPump(TestCase):
    def test_init(self):
        BinaryPump()

    def test_init_with_filename(self):
        BinaryPump(IO_SUM_FILE)

    def test_frame_positions_in_io_sum(self):
        p = BinaryPump(IO_SUM_FILE)
