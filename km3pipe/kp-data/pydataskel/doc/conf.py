...
# -*- coding: utf-8 -*-
#
# pydataskel documentation build configuration file, created by
...
version = '.'.join(pydataskel.__version__.split('.')[:2])
# The full version, including alpha/beta/rc tags.
release = pydataskel.__version__
...
htmlhelp_basename = 'pydataskeldoc'
...
man_pages = [
    (master_doc, 'pydataskel', 'pydataskel Documentation', [author], 1)
]
